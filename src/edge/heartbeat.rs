...
pub fn build_heartbeat(state: &SharedState) -> Heartbeat {
    ...
    Heartbeat {
        ...
        rejected_token_total: s.rejected_token.load(Ordering::Relaxed),
        rejected_draining_total: s.rejected_draining.load(Ordering::Relaxed),
        rejected_full_total: s.rejected_full.load(Ordering::Relaxed),
        rejected_subprotocol_total: s.rejected_subprotocol.load(Ordering::Relaxed),
        rejected_replay_total: s.rejected_replay.load(Ordering::Relaxed),
